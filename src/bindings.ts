...
async changePostProcessAdditionalUrlSetting(providerId: string, additionalUrl: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_additional_url_setting", { providerId, additionalUrl }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changePostProcessAdditionalModelSetting(providerId: string, model: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_additional_model_setting", { providerId, model }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async fetchPostProcessModelsFromUrl(providerId: string, url: string) : Promise<Result<string[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("fetch_post_process_models_from_url", { providerId, url }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getCustomHotkeyPrompts() : Promise<Result<CustomHotkeyPrompt[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_custom_hotkey_prompts") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async createCustomHotkeyPrompt(name: string, hotkey: string, promptText: string, mode: string) : Promise<Result<CustomHotkeyPrompt, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("create_custom_hotkey_prompt", { name, hotkey, promptText, mode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updateCustomHotkeyPrompt(id: string, name: string, hotkey: string, promptText: string, mode: string) : Promise<Result<CustomHotkeyPrompt, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_custom_hotkey_prompt", { id, name, hotkey, promptText, mode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deleteCustomHotkeyPrompt(id: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_custom_hotkey_prompt", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async checkCustomPromptHotkeyConflict(hotkey: string, excludeId: string | null) : Promise<Result<string | null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("check_custom_prompt_hotkey_conflict", { hotkey, excludeId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type PostProcessProvider = { id: string; label: string; base_url: string; allow_base_url_edit?: boolean; models_endpoint?: string | null; supports_structured_output?: boolean; additional_url?: string | null }
export type PromptMode = "selection" | "voice"
